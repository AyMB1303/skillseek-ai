...
\begin{tabular}{lcc}
  ...
  Travaux d'intégration continue & 2 & \textbf{6} \\
...
La chaîne d'intégration continue comptait deux travaux ; elle en compte \textbf{six}, exécutés à chaque poussée de code.
...
\begin{tabular}{lp{8.6cm}}
  ...
  Sécurité & Analyse du dépôt : secrets exposés, défauts de configuration \\[1mm]
